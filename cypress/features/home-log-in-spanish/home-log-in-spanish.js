...
And('Ingreso el usuario {string}', (username) => {
    loginpage.modal.getUser().type(username)
})

And('Ingreso la password {string}', (password) => {
    loginpage.modal.getPass().type(password)
})
